...
const BentoTilt = ({ children, className = '' }) => {
    ...
    return (
        <div className={className} ref={itemRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{transformStyle}} >
            {children}
        </div>
    );
    
}
const BentonCard = ({src,title,description})=>{
    return (
    ...
    <section className='bg-black pb-52'>
        <div className='container mx-auto px-3 md:px-10'>
           ...
           <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]' >
                <BentonCard src="videos/feature-1.mp4"
                            title={
                        <>
                        radia<b>n</b>t
                        </>
            ...
            <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
              ...
              <div className='bento-titl_1 row-span-1 ms:32 md:col-span-1 md:ms-0'>
                  <BentonCard
